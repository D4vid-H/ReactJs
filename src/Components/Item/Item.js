...
function Item({ id, nombre, precio, picturUrl, categoriName }) {
  ...
  return (
    <div className="max-w-sm bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
        <div>
            <img className="p-8 rounded-t-lg" src={productImg(picturUrl)} alt="product image" />
        </div>
      <div className="px-5 pb-5">
          ...
          <div className="flex justify-between items-center">
              ...
              <Link to={`/detail/${id}`} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Detalle</Link>
          </div>
      </div>
    </div>
